      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar">
          ...
          <li class="dropdown dropdown-fw dropdown-mega">
            <a class="dropdown-toggle" href="licitaciones.php" aria-expanded="false"
            data-animation="fade" role="button">Licitaciones </a>
          </li>
          <li class="dropdown dropdown-fw dropdown-mega">
            <a class="dropdown-toggle" href="empresas.php" aria-expanded="false"
            data-animation="fade" role="button">Empresas </a>
          </li>
        </ul>
        <!-- End Navbar Toolbar -->
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li class="dropdown">
            <a href="https://www.google.com" title="Notifications" aria-expanded="false"
            data-animation="scale-up" role="button" data-target="#exampleMultipleTwo" data-toggle="modal">
              Iniciar Sesión
            </a>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right dropdown-menu-media" role="menu">
              <li class="dropdown-menu-header" role="presentation">
                ...
                <span class="label label-round label-info">Nuevos Mensajes: 3</span>
              </li>
              <li class="list-group" role="presentation">
                <div data-role="container">
                  <div data-role="content">
                    <a class="list-group-item" href="javascript:void(0)" role="menuitem">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <h6 class="media-heading">Bot #1</h6>
                          <div class="media-meta">
                            <time datetime="2015-06-17T20:22:05+08:00">AHORA MISMO</time>
                          </div>
                          <div class="media-detail">Mensaje del bot invitando a registrarse</div>
                        </div>
                      </div>
                    </a>
                    <a class="list-group-item" href="javascript:void(0)" role="menuitem">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <h6 class="media-heading">Bot #2</h6>
                          <div class="media-meta">
                            <time datetime="2015-06-17T12:30:30+08:00">AHORA MISMO</time>
                          </div>
                          <div class="media-detail">Algún caso de éxito</div>
                        </div>
                      </div>
                    </a>
                    <a class="list-group-item" href="javascript:void(0)" role="menuitem">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <h6 class="media-heading">Bot #3</h6>
                          <div class="media-meta">
                    ...
                    <a class="list-group-item" href="javascript:void(0)" role="menuitem">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <h6 class="media-heading">Bot #4</h6>
                          <div class="media-meta">
                            <time datetime="2015-06-15T20:34:48+08:00">AHORA MISMO</time>
                          </div>
                          <div class="media-detail">Aprovecha y regístrate Gratis.</div>
                        </div>
                      </div>
                    </a>
                  </div>
          ...
          <li id="toggleChat">
            <a data-toggle="site-sidebar" href="#" title="Chat" data-url="site-sidebar.tpl">
