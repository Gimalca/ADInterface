...
<div class="slidePanel-inner">
  ...
  <div class="slidePanel-comment">
      <p class="text-center">Para poder comentar, necesitas registrarte en la plataforma. <a data-target="#exampleMultipleOne" data-toggle="modal"
                  type="button">Regístrate Aquí</a></p>
