...
<div class="slidePanel-inner">
  <section class="slidePanel-inner-section">
    <div class="media-header">
      <div class="tags">
        ...
        <a href="#" role="button">Base de Datos</a>
        <a href="#" role="button">Programación</a>
      </div>
      <div class="share">
        Compartir:
    ...
    <div class="media-content">
      ...
      <div class="text-center">
            <button type="button" class="btn btn-warning waves-effect waves-light">
              <span><i class="icon md-favorite" aria-hidden="true"></i>Agregar a Favoritos</span>
            </button>
  ...
  <div class="slidePanel-comment">
      <!--p class="text-center">Para poder comentar, necesitas registrarte en la plataforma. <a data-target="#exampleMultipleOne" data-toggle="modal" type="button">Regístrate Aquí</a></p-->
