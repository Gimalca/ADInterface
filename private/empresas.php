          ...
          <div class="row">
            ...
            <div class="panel">
              ...
              <div class="col-md-3 col-xs-12 text-center" id="step4">
                    <button class="btn btn-success waves-effect waves-light" type="button">Buscar Empresas</button>
            ...
            <li>
              <div class="media-item" data-toggle="slidePanel" data-url="panel-empresas.tpl">
                ...
                <div class="info-wrap">
                  ...
                  <div class="time"><a href="profile.php">Ver perfil</a></div>
                  <div class="media-item-actions btn-group">
                    ...
                    data-trigger="hover" type="button">trello
