...
<head>
  ...
  <title>AgenteDirecto | Error</title>
...
<body class="page-error page-error-400 layout-full">
  ...
  data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
      <header>
		<img src="assets/images/error.png" height="250px" width="250px">
        <h1 class="animation-slide-top">¡Un momentog!</h1>
        <p>Página no encontrada</p>
      </header>
      <p class="error-advise">Estimado usuario, la página que estás buscando no existe o no se encuentra en nuestro servidor</p>
      <a class="btn btn-primary btn-round" href="index.html">Ir a AgenteDirecto</a>
      <footer class="page-copyright">
        <!--p>WEBSITE BY amazingSurge</p-->
        <p>© 2016. AgenteDirecto.com</p>
        <div class="social">
          <a href="https://www.twitter.com/agentedirecto">
            <i class="icon bd-twitter" aria-hidden="true"></i>
          </a>
          <a href="https://www.facebook.com/agentedirecto">
